...
import afd from "../assets/postpage.png"
...
return(
    ...
    >
      ...
      <div className="social-links text-center">
        ...
        <a href='https://github.com/vallarasu1023/inkwell-journal' className="google-plus"><FaGithub /></a>
...
<div className="container" data-aos="fade-up" data-aos-delay="100">
  ...
  <div className="row gy-4 justify-content-center">
    <div className="col-lg-4">
      <img src={profilepic} className="img-fluid" style={{ height: '560px', objectFit: 'cover',width:'400px' }} alt=""/>
    </div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="resume-item">
              <h4>2.Inkwell Journal- BLOG PLATFORM                                                                                                                            </h4>
              <h5>2026- Present</h5>
              <ul>
                <li>Built and deployed a full-stack blogging platform with article publishing and user interaction features </li>
                <li>Designed secure authentication using JWT and implemented protected routes</li>
                <li>Designed secure authentication using JWT and implemented protected routes </li>
                <li>Engineered features such as draft auto-save, bookmarking, clapping, and profile management </li>
                <li>Implemented optimized search with debouncing and dynamic filtering </li>	
                <li>Integrated third-party image API for enhanced content creation </li>
                <li>Structured scalable backend APIs with Express and MongoDB</li>
                <li><span classNamee='tech'>Tech:</span> React.js, Node.js, Express.js, MongoDB, JWT, Axios</li>
              </ul>
            </div>
          </div>
        </div>
...
<div className="container section-title" data-aos="fade-up">
  <h2>Project</h2>
  <p>Inkwell is a full-stack blogging platform built using the MERN stack (MongoDB, Express.js, React, Node.js). 
    It provides a clean and distraction-free writing experience, allowing users to create, publish, and explore content seamlessly. 
    The platform also integrates image search functionality and automated news content, making it more than just a traditional blog system.</p>
  </div>
    ...
    <div className="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
        <div className="portfolio-content h-100">
          ...
          <div className="portfolio-info">
            <h4>🔐 Signup Page</h4>
            <p>User registration with form validation and secure authentication flow.</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
        <div className="portfolio-content h-100">
          ...
          <div className="portfolio-info">
            <h4>🖼️ Image Search</h4>
            <p>API-powered image search with grid layout and filters.</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
        <div className="portfolio-content h-100">
          ...
          <div className="portfolio-info">
            <h4>🔥 Trending</h4>
            <p>Sidebar showcasing popularbr
               content for discovery..</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
        <div className="portfolio-content h-100">
          ...
          <div className="portfolio-info">
            <h4>📰 Home Feed</h4>
            <p>Dynamic article feed with category filtering and responsive card layout</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
        <div className="portfolio-content h-100">
          ...
          <div className="portfolio-info">
            <h4>✍️ Editor</h4>
            <p>Blog editor with draft saving and structured <br />content creation.</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
        <div className="portfolio-content h-100">
          ...
          <div className="portfolio-info">
            <h4>📖 Blog Page</h4>
            <p>Clean reading interface with media and engagement features.</p>
          </div>
        </div>
      </div>
    </div>
